    ...
    public partial class OrderEntryForm : Form
    {
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sql = "UPDATE Orders SET " + "customer_id = " + custId + ", " +  "employee_no = " + empNo + ", " + "order_date = '" + oDate.ToString("yyyy-MM-dd") + "', " +  "order_time = '" + oTime + "', " + "order_amount = " + total + ", " + "payment_method = '" + pay + "', " + "status = '" + st + "', " + "location_id = " + locId + ", " + "dispatch_time = '" + disp + "' " + "WHERE order_no = " + orderNo;
                SqlCommand cmd = new SqlCommand(sql, con);
                con.Open();
